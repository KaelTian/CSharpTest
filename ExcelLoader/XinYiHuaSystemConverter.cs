...
namespace ExcelLoader
{
    ...
    public class XinYiHuaSystemConverter
    {
        ...
        public void ConvertToClassPropertiesFromExcel(string excelFilePath, string outputFilePath)
        {
        ...
        public void GenerateDBMappingConfig(string excelPath, string outputPath)
        {
